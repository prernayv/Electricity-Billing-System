...
public class Signup extends JFrame implements ActionListener{
    ...
    Signup(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(249,194,56),2),"Create Account",TitledBorder.LEADING,TitledBorder.TOP,null,new Color(249,194,56)));
       ...
       lblpassword.setForeground(Color.GRAY);
        ...
        ImageIcon i1 =new ImageIcon(ClassLoader.getSystemResource("icon/New3.png"));
     ...
     public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == create){
            String atype = accountType.getSelectedItem(); //values extraction
            ...
            try{
               ...
               Conn c = new Conn(); // conn stabilished
               ...
               c.s.executeUpdate(query);  // to execute
